...
![alt Some sketches from the Quick draw dataset]({{ page.url }}/quickdrawpreview.jpg  "Some sketches from the Quick draw dataset")

![alt Some 3D models from the Shapenet dataset]({{ page.url }}/shapenetcore.png "Some 3D models from the Shapenet dataset")
...
![alt A 3D mesh]({{ page.url }}/images/silhouette_edges/M000019.png  "a 3D Mesh") ![alt Line rendering from position 1]({{ page.url }}/images/silhouette_edges/M000019_1.png  "Line rendering from position 1") ![alt Line rendering from position 2]({{ page.url }}/images/silhouette_edges/M000019_4.png  "Line rendering from position 2")
...
![alt A rendering of a boat from position 1 ]({{ page.url }}/images/silhouette_edges/M000102_010.jpg  "A rendering of a boat from position 1") ![alt Extracted edges]({{ page.url }}/images/silhouette_edges/M000102_010_edges.jpg  "Extracted edges")  ![alt A rendering of a boat from position 2 ]({{ page.url }}/images/silhouette_edges/M000102_001.jpg  "A rendering of a boat from position 2") ![alt Extracted edges]({{ page.url }}/images/silhouette_edges/M000102_001_edges.jpg "Extracted edges")
...
![alt A textured airplane model ]({{ page.url }}/images/silhouette_edges/M000003_001.jpg "A textured airplane model ") ![alt Voxels]({{ page.url }}/images/silhouette_edges/M000003_voxels.jpg "Voxels") ![alt Extracted edges 1]({{ page.url }}/images/silhouette_edges/M000003_001_edges.jpg  "Extracted edges 1") 
...
![alt Voxels]({{ page.url }}/images/silhouette_edges/M000003_voxels.jpg "Voxels") ![alt Extracted edges 1]({{ page.url }}/images/silhouette_edges/M000003_001_edges.jpg  "Extracted edges 1")   ![alt Similar hand-drawn sketch 1]({{ page.url }}/images/11.png "Similar hand-drawn sketch 1") 
